...
def load_cora_biased(test_percent, val_percent, use_sparse_representation, device):
    # Load data (use same functions as tensorflow's implementation)
    adj_init, features = load_data("cora", "./data/cora.cites" )
    adj, val_edges, val_edges_false, test_edges, test_edges_false =  mask_test_edges_biased_negative_samples(adj_init, 10.)
...
data_suggested_parameters_sets = {"cora":{
                                        ...
                                        "biased":{"test_percent": 10., "val_percent": None,  "use_sparse_representation": True},
                                        }
                                }